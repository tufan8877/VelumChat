...
export const translations = {
  en: {
    ...
    welcomeToWhispergram: 'Welcome to VelumChat',
    ...
    faq10Answer: "Yes. VelumChat is open source and can be audited for security. The code is available for review and self-hosting.",
  ...
  de: {
    ...
    welcomeToWhispergram: 'Willkommen bei VelumChat',
    ...
    serverExplanation: "VelumChat verwendet eine minimale Server-Architektur für maximale Privatsphäre:",
    ...
    faq10Answer: "Ja. VelumChat ist Open Source und kann auf Sicherheit geprüft werden. Der Code ist für Überprüfung und Selbst-Hosting verfügbar.",
  ...
  ru: {
    aboutText: "VelumChat — сквозное шифрование сообщений.",
    saving: "Сохранение...",
    tokenMissing: "Токен отсутствует — войдите заново.",
    // Welcome Page
    ...
    serverExplanation: "VelumChat использует минимальную серверную архитектуру для максимальной приватности:",
    ...
    faq10Answer: "Да. VelumChat имеет открытый исходный код и может быть проверен на безопасность. Код доступен для изучения и самостоятельного хостинга.",
  ...
  fr: {
    ...
    serverExplanation: "VelumChat utilise une architecture serveur minimale pour une confidentialité maximale :",
    ...
    faq10Answer: "Oui. VelumChat est open source et peut être audité pour la sécurité. Le code est disponible pour examen et auto-hébergement.",
  ...
  es: {
    ...
    welcomeToWhispergram: 'Bienvenido a VelumChat',
    ...
    serverExplanation: "VelumChat usa una arquitectura de servidor mínima para máxima privacidad:",
  ...
  tr: {
    ...
    saving: "Kaydediliyor...",
    tokenMissing: "Token eksik — lütfen yeniden giriş yapın.",
    // Welcome Page
    ...
    serverExplanation: "VelumChat maksimum gizlilik için minimal sunucu mimarisi kullanır:",
